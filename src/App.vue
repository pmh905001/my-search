    ...
    <el-main>
      <div id="container">
        <div class="result" v-for="fav in favs" :key="fav.id">
          ...
          <div v-if="fav.url"><a :href="fav.url" target="_blank">here</a></div>
          <div v-else-if="fav.share_url"><a :href="fav.share_url" target="_blank">here</a></div>
          <div v-else-if="fav.share_info && fav.share_info.share_url"><a :href="fav.share_info.share_url" target="_blank">here</a></div>
          <div v-else-if="fav.comment_base && fav.comment_base.share && fav.comment_base.share.share_url"><a :href="fav.comment_base.share.share_url" target="_blank">here</a></div>
          <div v-else-if="fav.schema"><a :href="fav.schema" target="_blank">here</a></div>
          <div v-else >{{ fav}}</div>
        </div>
